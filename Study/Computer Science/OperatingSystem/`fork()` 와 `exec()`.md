...
**중요**: 자식이 x를 200으로 바꾸어도 부모의 x는 여전히 100입니다! (메모리가 완전히 분리)
...
## 3️⃣ Copy-on-Write (CoW): 최적화 기법

### 문제: fork()가 너무 비싼 작업이다
